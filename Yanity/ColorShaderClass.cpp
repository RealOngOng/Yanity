...
void ColorShaderClass::SetVertexShaderPath(const WCHAR* wstr)
{
	VertexShaderPath = const_cast<WCHAR*>(wstr);
}
WCHAR* ColorShaderClass::GetVertexShaderPath()
{
	return VertexShaderPath;
}
void ColorShaderClass::SetPixelShaderPath(const WCHAR* wstr)
{
	PixelShaderPath = const_cast<WCHAR*>(wstr);
}
WCHAR* ColorShaderClass::GetPixelShaderPath()
{
